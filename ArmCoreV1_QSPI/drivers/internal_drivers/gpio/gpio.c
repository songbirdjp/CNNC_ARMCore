...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(CHIP_RUN_LED_GPIO_Port, CHIP_RUN_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OSPI5_ncs_GPIO_Port, OSPI5_ncs_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, SPI3_NCS_Pin|DriveBoardCtrl_Pin|W5500_RST_Pin|W5500_INT_Pin
                          |WATCHDOG2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = CHIP_RUN_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(CHIP_RUN_LED_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = SPI3_NCS_Pin|DriveBoardCtrl_Pin|W5500_INT_Pin|WATCHDOG2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Pin = CarrierServoSignal_Pin|WATCHDOG1_Pin|SPI1_NCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
