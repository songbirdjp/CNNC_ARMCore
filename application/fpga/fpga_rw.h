...
#define RT_FPGA_UPLOAD_PAYLOAD_LEN  180 //it is the same as nrt payload from fpga
#define NRT_FPGA_UPLOAD_PAYLOAD_LEN  180
...
#define	CMD_VEL_SET	        0x1b
#define	CMD_HOME_VEL_SET	0x1c
#define	CMD_PARK_POS	    0x1d
...
#define	CMD_SPD_ANA		    0x41
#define	CMD_MOV_TIM		    0x42
#define	CMD_JAW_POS		    0x48

#define	CMD_STA_REQ		    0x50 // state request
#define	CMD_CFG_DONE		  0x60
