...
struct dev_sdram
{
    ...
    int8_t (*read)(struct dev_sdram *sdram, uint32_t offset, uint8_t *data, uint16_t len, uint32_t timeout);
    int8_t (*write)(struct dev_sdram *sdram, uint32_t offset, uint8_t *data, uint16_t len, uint32_t timeout);
